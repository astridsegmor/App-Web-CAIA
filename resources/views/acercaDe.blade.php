...
<head>
	...
	<title>Aplicación WEB Departamento CAIA - IPASME TRUJILLO</title>
    ...
    <div class="wrapper">
        ...
        <div class="sp">
            <ul class="menu">
                ...
                <li>
                    <a href="{{ url('/servicios') }}"><h4>Servicios</h4></a>
                </li>
                <li>
                    <a href="#"><h4>Acerca de</h4></a>
                </li>
            </ul>
        </div>
    </nav>
        <cuerpo class="main">
            <center>
            <h1 style="font-family:'Nunito', sans-serif; font-weight:bold;">Aplicación WEB Departamento CAIA - IPASME TRUJILLO</h1>
            <h2 style="font-family:'Nunito', sans-serif; font-weight:bold; padding-left:50px; padding-right: 50px;">
                Aplicación WEB para el registro y control de la información de los Afiliados y sus Beneficiarios
                en el Centro de Atención Integral al Afiliado (CAIA), departamento perteneciente a la Coordinación Financiera del 
                Ipasme Trujillo.</h2>
            <h3 style="font-family:'Nunito', sans-serif; font-weight:bold; padding-left:80px; padding-right: 80px;">
                Diseñada y construida en la Universidad Politécnica Territorial del estado Trujillo "Mario Briceño Iragorry" (UPTTMBI) 
                en el Programa Nacional de Formación de Ingeniería Informática como Proyecto Socio-Tecnológico en el trayecto IV,
                 por los estudiantes:</h3>
            <div style="text-align: center; font-size: 18px; font-weight: bold; padding:8px;">
                <a>T.S.U. Astrid Estefanía Segovia Moreno</a><br>
                <a>T.S.U. Grecia Alexandra Cepeda Quintero</a><br>
                <a>T.S.U. Ronny Alexander Balbuena Morillo</a><br>
                <a>T.S.U. Sergio Alejandro Daboin Vásquez</a><br>
            </div>
