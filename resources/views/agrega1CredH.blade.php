...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Solicitud de Créditos Hipotecarios</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		  <form action="../../CaiaIpasme/public/agregaDCredH" method="post">
          @csrf
			 ...
			 <input class="boton" type="submit" style="font-size:16px;border-radius: 5px" value="Buscar">
             <!--a class="boton" style="font-size:16px;border-radius:5px;" name="OtroA" value="Crédito Hipotecario" href="../../CaiaIpasme/public/agregaDCredH">Crédito Hipotecario</a> -->
		  </form>
		<hr>
       </center>
    </div>
