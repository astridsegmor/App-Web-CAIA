...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Emitir Reporte General de Afiliados</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>

<?php	
        echo '<strong>Se generó el Reporte General de Afiliados.....</strong><br>';
?>
		<script>
				window.open("../public/repAfilpdf.php","_blank");
		</script>
	  <hr>
      </center>
    </div>
