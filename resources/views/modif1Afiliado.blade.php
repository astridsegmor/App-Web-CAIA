...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Editar Datos de un Afiliado</h1><br><br>
    </div>
    <div>
        <center>
		<hr/>
        <form action="../../CaiaIpasme/public/modif2Afiliado" method="post">
        <?php //<form action="{{action('AfiliadoController@editAfil', $mAfil->id)}}" method="post"> --?>
            @csrf
