...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Agregar datos de los Beneficiarios</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		  <form action="../public/agregaDBenef" method="post">
             @csrf
