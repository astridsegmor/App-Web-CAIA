...
<body style="padding:8px;">
    ...
    <div class="fondo">
            ...
            <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Reporte Créditos del Afiliado</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		<table>
		  <form action="../public/repCApdf.php" method="post" target="_blank">
            @csrf
			 ...
			 <input class="boton" type="submit" style="font-size:16px;border-radius: 5px" value="Visualizar">
		  </form>
		</table>
		<hr>
       </center>
