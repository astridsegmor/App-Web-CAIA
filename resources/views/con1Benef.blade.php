...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Consulta de Beneficiarios x Afiliado</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		<table>
		  <form action="../../CaiaIpasme/public/con2Benef" method="post">
            @csrf
