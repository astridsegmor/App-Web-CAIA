...
<body style="padding:8px;">
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Solicitud de Créditos Integrados</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		  <form action="../../CaiaIpasme/public/agregaDCred" method="post">
          @csrf
