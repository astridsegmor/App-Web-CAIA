...
<body style="padding:8px;">
    ...
    <div class="fondo">
            ...
            <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Emitir Constancia/Carnet</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		  <form action="../public/verConstAfil" method="post">
            @csrf
			 ...
			 <input class="boton" type="submit" style="font-size:16px;border-radius: 5px" value="Visualizar Constancia">
		  </form>
		<hr>
       </center>
    </div>
