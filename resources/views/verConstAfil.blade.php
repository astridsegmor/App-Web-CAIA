...
<body style="padding:8px;">
    ...
    <div class="fondo">
            ...
            <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Emitir Constancia del Afiliado</h1><br><br>
    </div>
    ...
    <?php	
        ...
        {
            echo '<strong>Se generó la Constancia del Afiliado de cédula.....'.$cedula.'</strong><br>';
    ?>
            <script>
                    window.open("../public/reporte.php?cedulaA="+"<?php echo $cedula?>","_blank");
            </script>
    <?php	
        }
        else
        {
            echo '<strong>No está registrado el Afiliado de cédula.....'.$cedula.'</strong><br>';
        }
    ?>
	  <hr>
      </center>
