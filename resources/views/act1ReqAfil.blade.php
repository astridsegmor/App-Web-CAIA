...
<nav>
    ...
    <div class="fondo">
        ...
        <h1 style="font-size:30px; font-family: 'Nunito', sans-serif; font-weight:bold; text-align:center;">Actualizar requisitos del Afiliado</h1><br><br>
    </div>
    <div style="padding-bottom: 10px;">
        <center>
		<hr>
		  <form action="../../CaiaIpasme/public/actReqAfil" method="post">
            @csrf
			 Cedula Afiliado: <input type="text" name="CedulaAF" id="cedulaB" pattern="[V|E]-[0-9]{2}.[0-9]{3}.[0-9]{3}" title="Ej.-> V-04.333.555, E-81.222.333" 
