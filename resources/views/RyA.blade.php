    ...
    <div class="wrapper">
        ...
        <div class="sp">
            <ul class="menu">
                ...
                <li>
                    <a href="#"><h4>Registro y Control de Afiliados</h4></a>
                </li>
                <li>
        ...
        <cuerpo class="main">
            <center>
            <h1 style="font-family:'Nunito', sans-serif; font-weight:bold;">Registro y Control de Afiliados (CAIA)</h1>
            <h3 style="font-family:'Nunito', sans-serif; font-weight:bold; padding-left:50px; padding-right: 50px;">Tiene la responsabilidad de verificar y actualizar el ingreso de afiliadas y afiliados a través de la data digitalizada enviadas por el MPPE, Gobernaciones, 
                Alcaldías, Colegios e Institutos Universitarios y otros entes Afiliados al Instituto. Debe
                mantener un proceso efectivo, ágil y sistemático para el registro, actualización y control de los afiliados y afiliadas y de los organismos que suscribieron contrato con el IPASME, en otras palabras,     
                mantener actualizados los registros de la base de datos de los afiliados y afiliadas y su grupo familiar de los entes tramitados a través de CAIA, unidades regionales o Sede Administrativa.</h3>
                <h3><a href="PlanillaActAfiliado.pdf" target="_blank" rel="noopener noreferrer"></h3>
                Descargar y llenar Planilla de Afiliación</a><br></br>
